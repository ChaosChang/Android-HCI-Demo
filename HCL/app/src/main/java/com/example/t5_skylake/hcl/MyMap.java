...
import com.example.t5_skylake.hcl.Map.MarkObject;
...
/**
 * Created by T5-SKYLAKE on 2017/6/6.
 */
public class MyMap extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void setBitmap(Bitmap bitmap) {//加载图片
        this.mBitmap = bitmap;

        // 设置最小缩放为铺满屏幕，最大缩放为最小缩放的4倍，获取最小缩放的参数
